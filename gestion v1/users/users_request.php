    ...
    <main class="MainBody">
        ...
        <div class="Number_inputs" >
            ...
            <form action="" method="post">
                <div>
                    <input type="Number" name="Nb" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" id="NumberRank"  placeholder="Nombre des Designiations">
