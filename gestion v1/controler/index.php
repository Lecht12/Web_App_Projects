...
include "../data_management/controller_data.php";
session_start();
controle();
add_emails();
?>
...
<head>
    ...
    <title>Controller Space</title>
    <style>
        <?php include "../css_style/controller.css" ?>
    </style>
</head>
<body>
    <!---Header of the page-->
    ...
    <main class="mainBody">
        ...
        <!--requests statistics-->
        <div class="statistics_container" id="top_x_div"></div>
        <!--Contact Area-->
